...
T Lista<T>::antePenultimo(){
    Nodo<T> *nodo1 = inicio;
    if(nodo1 == nullptr)   std::cout << "No tenes nodos" << std::endl;
    else{
        Nodo<T> *nodo2 = nodo1->getSiguiente();
        if(nodo2 == nullptr)   std::cout << "Tenes 1 solo nodo" << std::endl;
        else{
            Nodo<T> *nodo3 = nodo2->getSiguiente();
            if(nodo3 == nullptr)   std::cout << "Tenes solo 2 nodos" << std::endl;
            else{
                while (nodo3->getSiguiente() != nullptr){
                    nodo1 = nodo2;
                    nodo2 = nodo3;
                    nodo3 = nodo3->getSiguiente();
                }
                return nodo1->getDato();
            }
        }
    }
}
